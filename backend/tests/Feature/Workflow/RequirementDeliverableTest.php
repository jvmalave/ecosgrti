...
beforeEach(function () use (&$consultantId, &$user) {
    ...
    DB::table('security.persons')->insert([
        ...
        'first_name' => 'Jane', 
        'last_name'  => 'Doe', 
        'email'      => 'jane.doe_' . Str::random(5) . '@cantv.com.ve', 
        'created_at' => now(), 
        'updated_at' => now()
    ]);
    ...
    // 5. Autenticar explícitamente en el guard de la API
...
it('registra un entregable exitosamente', function () use (&$consultantId) {
    ...
    $this->assertDatabaseHas('workflow.deliverables', [
        'name'           => 'Manual de Usuario', 
        'requirement_id' => $req->id, 
        'description'    => 'plan para las pruebas'
    ]);
});

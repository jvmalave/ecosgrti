// import { Component, OnInit, inject, signal, effect, Output, EventEmitter } from '@angular/core';
...
// import { UnifiedPersonPayload } from '../../data-access/models/unified-person.model';
// import { RequestingUnitOption } from '../../data-access/models/unified-person.model';
...
//   public systemRoles = ['Admin', 'Coord', 'Consultant', 'Manager', 'Viewer'];
...
//         // 'units' ya es el arreglo extraído, lo seteamos directamente
//         this.requestingUnits.set(units);
//       },
//       error: (err: unknown) => {
//         console.error('Error al cargar unidades solicitantes:', err);
//         // Protegemos la vista seteando un arreglo vacío
...
//   // Método que emite el evento de cierre al HTML
//     public onClose(): void {
//     //console.log('1. [Hijo] Botón de cierre presionado. Emitiendo evento al Dashboard...');
...
//     const payload: UnifiedPersonPayload = this.personForm.value;
    
//     this.personService.createUnifiedPerson(payload).subscribe({
//       next: (res) => {
//         // Reemplazo por showSuccess
//         this.notificationService.showSuccess('¡Éxito!', res.message);
...
//           // Reemplazo por showWarning para avisar de los errores en rojo
//           this.notificationService.showWarning(
//             'Validación fallida', 
...
//         } else {
//           // Reemplazo por showError para fallos críticos (ej. 500)
...
import { UnifiedPersonService } from '../../data-access/services/unified-person.service';
import { UnifiedPersonPayload, RequestingUnitOption, UnifiedPerson } from '../../data-access/models/unified-person.model';
